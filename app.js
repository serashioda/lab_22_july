...
function multiply(a,b){ //eslint-disable-line
  var output = a * b;
  var message = 'The product of ' + a + ' and ' + b + ' is ' + output + '.';
  console.log(message + ' is the expected output.');
  return [output, message];
}
...
function sumAndMultiply(a,b,c){
  ...
  var multiTwo = multiply(multiOne, c)[0];//eslint-disable-line
  ...
  return [sumOne, message, message1, multiTwo];
}
...
function sumArray(testArray){
  ...
  var message = testArray + ' was passed in as an array of numbers, and ' + ultraSum + ' is their sum.';
  console.log(message + 'is the actual output.');//eslint-disable-line
